package com.emirates.example.model;
...
public class FlightSegment {
    ...
    public boolean equals(Object o) {
        ...
        if (formattedDepartureTime != null ?
            !formattedDepartureTime.equals(segment.formattedDepartureTime) :
            segment.formattedDepartureTime != null) {
            return false;
        }
        return formattedArrivalTime != null ?
            formattedArrivalTime.equals(segment.formattedArrivalTime) :
            segment.formattedArrivalTime == null;
    }
    ...
    public String toString() {
        return "FlightSegment{" + "flightNumber=" + flightNumber + ", departureAirport='" + departureAirport + '\'' + ", departureTime="
            + departureTime + ", arrivalAirport='" + arrivalAirport + '\'' + ", arrivalTime=" + arrivalTime + ", formattedDepartureTime='"
            + formattedDepartureTime + '\'' + ", formattedArrivalTime='" + formattedArrivalTime + '\'' + '}';
    }
}